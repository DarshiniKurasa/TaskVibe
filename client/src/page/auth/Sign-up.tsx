...
const SignUp = () => {
  ...
  const formSchema = z.object({
    ...
    email: z.string().trim().email("Invalid email address").min(1, { message: "Workspace name is required" }),
                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  <div className="grid gap-6">
                    ...
                    <div className="text-center text-sm">
                      Already have an account? <Link to="/" className="underline underline-offset-4">Sign in</Link>
                    </div>
                  </div>
                </form>
              </Form>
